...
class Info_Screen():
    def __init__(self,screen):
        ...
        self.rect_color = (47,150,150)
        self.text_color = (0,0,0)
        self.font = pygame.font.SysFont(None,30)
        self.title_font = pygame.font.SysFont(None,100)
        self.title = 'Alien Invasion'
        self.subtitle = ' - programmed by Debraj'
        ...
        self.msgs=['Defeat the Aliens and earn points by shooting them',
                   'with laser canon. Also dodge their bulets.',
                   'Controls:',
                   'Use "<" and ">" keys to move horizontally',
    ...
    def prep_msgs(self,msgs):
        ...
        self.msg_image_rect_1.centery=self.rect.centery - 100 +10
        self.msg_image_rect_2.centery=self.rect.centery - 50 + 10
        self.msg_image_rect_3.centery=self.rect.centery + 0 + 10
        self.msg_image_rect_4.centery=self.rect.centery + 50 + 10
        self.msg_image_rect_5.centery=self.rect.centery + 100 + 10
