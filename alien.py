...
class Alien(Sprite):
    def __init__(self,ai_s,screen):
        ...
        self.screen=screen
        self.ai_s=ai_s
        self.image_1=pygame.image.load('data/ufo.png')
        self.image_2 =pygame.image.load('data/ufo1.png')
        self.image_1_white=pygame.image.load('data/ufo_freeze.png')
        self.image_2_white =pygame.image.load('data/ufo_freeze.png')
